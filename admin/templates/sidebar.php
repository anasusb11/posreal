        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="transaksi" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="donasi_berjalan.php">Transaksi Donasi Berjalan</a>
                        <a class="collapse-item" href="donasi_selesai.php">Transaksi Donasi Selesai</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="toko" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Riwayat Toko:</h6>
                        <a class="collapse-item" href="toko.php">List Toko</a>
                        <a class="collapse-item" href="master_produk.php">List Master Produk</a>
                    </div>
                </div>
            </li>
            <!-- Divider -->
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Riwayat Transaksi:</h6>
                        <a class="collapse-item" href="transaksi_berjalan.php">Transaksi Berjalan</a>
                        <a class="collapse-item" href="transaksi_selesai.php">Transaksi Selesai</a>
                    </div>
                </div>
            </li>
            <!-- Divider -->
