...
WHERE konfirmasi_admin='Ya' AND konfirmasi_toko='Ya'
";
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($transaksi as $key => $value) : ?>
                                            <tr>,
                                                ...
                                                <td><a href="detail_transaksi.php?id=<?= $value['id_transaksi'] ?>">Detail</a> | <a href="delete.php?id=<?= $value['id_store'] ?>" onclick="return confirm('Are you sure delete?')">Delete</a></td>
                                            </tr>
                                        <?php endforeach;
                                        ?>
                                    </tbody>
